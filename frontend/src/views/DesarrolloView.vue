...
<template>
  ...
  >
    ...
    <div class="area-content">
      <h1 class="area-title">Desarrollo e inclusión social</h1>
      <p class="area-descripcion">Impulsaremos oportunidades y programas para mejorar la calidad de vida de niños, jóvenes, mujeres, adultos mayores y familias de La Joya.</p>
