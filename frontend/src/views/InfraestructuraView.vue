...
<template>
  ...
  >
    ...
    <div class="area-content">
      <h1 class="area-title">Obras e infraestructura</h1>
      <p class="area-descripcion">Priorizaremos obras que respondan a las necesidades reales de cada sector, mejorando vías, espacios públicos y servicios para el desarrollo del distrito.</p>
