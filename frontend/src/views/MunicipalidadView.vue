...
<template>
  ...
  >
    ...
    <div class="area-content">
      <h1 class="area-title">Municipalidad eficiente</h1>
      <p class="area-descripcion">Una municipalidad moderna, transparente y cercana, que atienda con rapidez y administre responsablemente los recursos de La Joya.</p>
