...
<template>
  ...
  >
    ...
    <div class="area-content">
      <h1 class="area-title">Seguridad</h1>
      <p class="area-descripcion">Fortaleceremos la seguridad ciudadana con mayor prevención, vigilancia, recuperación de espacios públicos y coordinación permanente con la población.</p>
